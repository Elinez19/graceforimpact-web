...
const Footer = () => {
  return (
    <>
      <footer className="border-t border-stroke bg-purple dark:border-strokedark dark:bg-blacksection">
                  ...
                  <form action="#">
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-full border border-stroke px-6 py-3 shadow-solid-11 focus:border-orange focus:outline-none dark:border-strokedark dark:bg-black dark:shadow-none dark:focus:border-orange"
                      />
                      ...
                      <button
                        ...
                        <svg
                          className="fill-[#757693] hover:fill-orange dark:fill-white"
                          width="20"
                          height="20"
                          viewBox="0 0 20 20"
                          fill="none"
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            <motion.div
              ...
              <p className="text-white">
                &copy; {new Date().getFullYear()} GraceForImpact. All rights
                reserved
              </p>
            </motion.div>
