      ...
      <div className="xl:container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
        <div className="mb-12 space-y-2 ml-15">
          ...
          <p className="lg:w-6/12 text-gray-600 dark:text-gray-300 text-left">
            Empowering rural people to reach their full potential.
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div className="group p-6 sm:p-8 rounded-3xl bg-white border border-gray-100 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
            ...
            <div className="mt-6 relative">
              ...
              <p className="mt-6 mb-8 text-gray-600 dark:text-gray-300">
                Capacity development of students, teachers, young medical
          ...
          <div className="group p-6 sm:p-8 rounded-3xl bg-white border border-gray-100 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
            ...
            <div className="mt-6 relative">
              ...
              <p className="mt-6 mb-8 text-gray-600 dark:text-gray-300">
                Equipping local doctors and specialists with information,
